...
class ModelWrapper(nn.Module):
    ...
    def forward(self, x):
        ...
        return model_out.sum(dim=(0, 2, 3, 4))  # [batch, num_classes]
        ...
        logger.info(f"{(model_out * selected_inds).sum(dim=(0, 2, 3, 4)).shape=}")
...
plot_slices(prediction, "Prediction", cmap='gray')
# %%
...
plot_slices(normalized_attributions, "Integrated Gradients", cmap='gray')
# %%